// localStorage.clear();
        // Função para exibir o conteúdo inicial
        ...
        // Função para carregar pagamentos do localStorage
        function carregarPagamentos() {
            let pagamentos = localStorage.getItem("Pagamentos");
            if (pagamentos) {
                return JSON.parse(pagamentos);
            } else {
                return [];
            }
        }
    
        // Função para salvar novo pagamento no localStorage
        ...
        // Função para atualizar o JSON e salvar no localStorage
        ...
        function validarFormulario() {
            ...
            if (valid) {
                // Se for válido, chama a função AtualizaJson e armazena no localStorage.
                AtualizaJson();
            } else {
        ...
        function exibeConteudo() {
            ...
            <div class="artefato">
                ...
                <div class="dadosCartao">
                    ...
                    <span>
                        <h5>Total:</h5>
                        <input type="text" id="valorPagamento">
                    </span>
                </div>
            </div>
            <div id="pagamento" onclick="validarFormulario();">
                <div>
